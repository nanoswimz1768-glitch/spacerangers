...
public partial class EnemyStatusLayer : Node2D
{
    ...
    private void DrawShipStatus(ShipState ship)
    {
        ...
        var rowHeight = 3.5f;
        var gap = 2.2f;
        var panelHeight = rowHeight * 3f + gap * 2f + 5f;
        ...
        DrawRect(new Rect2(topLeft - new Vector2(3f, 3f), new Vector2(width + 6f, panelHeight)), new Color(1f, 0.28f, 0.18f, 0.28f), false, 1f);
        DrawStatusBar(topLeft, width, rowHeight, ship.Combat.Shield, ship.Combat.MaxShield, new Color(0.18f, 0.82f, 1f, 0.92f));
        DrawStatusBar(topLeft + new Vector2(0f, rowHeight + gap), width, rowHeight, ship.Combat.Armor, ship.Combat.MaxArmor, new Color(1f, 0.64f, 0.18f, 0.92f));
        DrawStatusBar(topLeft + new Vector2(0f, (rowHeight + gap) * 2f), width, rowHeight, ship.Combat.Structure, ship.Combat.MaxStructure, new Color(1f, 0.18f, 0.16f, 0.92f));
    }
